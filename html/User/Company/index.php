          ...
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                ...
                <h5 class="card-title text-primary">Good Morning/Afternoon/Evening! Nayan Patoliya</h5>
                <p class="mb-4">
        ...
        <div class="card">
          <div class="row row-bordered g-0">
            ...
            <div class="row g-0">
              ...
              <div class="col-md-7">
                <div class="card-body">
                  <h5 class="card-title">Nayan Pvt. Ltd.</h5>
                  <p class="card-text">
                    Nayan Pvt Ltd. is a leading IT company specializing in innovative software solutions and digital
