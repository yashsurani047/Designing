          ...
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                ...
                <h5 class="card-title text-primary">Good Morning/Afternoon/Evening! Yash Surani</h5>
                <p class="mb-4">
          ...
          <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <h3 class="card-title mb-2">230+</h3>
          ...
          <div class="col-lg-6 col-md-12 col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <h3 class="card-title text-nowrap mb-1">83+</h3>
                <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>Today
                  +28.10%</small>
              </div>
            </div>
        ...
        <div class="card">
          <div class="row row-bordered g-0">
            ...
            <div class="row g-0">
              ...
              <div class="col-md-7">
                <div class="card-body">
                  <h5 class="card-title">Admin Yash Surani</h5>
                  <p class="card-text col-lg-8">
                    <b>
                  An Administrator plays a key role in managing and coordinating various tasks within an organization. They ensure smooth day-to-day operations by handling activities such as scheduling, communication, and office management. Admins are responsible for organizing meetings, maintaining records, managing office supplies, and coordinating with different departments to ensure the flow of information.</b>
                  </p>
                </div>
              </div>
            </div>
