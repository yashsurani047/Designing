            ...
            <div class="card-body">
              ...
              <form class="mb-3" method="POST">
                <div class="mb-3">
                  ...
                  <span class="input-group-text cursor-pointer"><i class="bx bx-check" style="color:green"></i></span>
                  <span class="input-group-text cursor-pointer"><i class="bx bx-x" style="color:red"></i></span>
                </div>
                <div class="mb-3">
