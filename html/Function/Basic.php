...
if(isset($_SESSION['Usertype'])){
    ...
    if (strpos($url, "User/".$_SESSION['Usertype']."/") || strpos($url, "user/".$_SESSION['Usertype']."/") || strpos($url, "Function") || strpos($url, "vendor") || strpos($url, "Profile") || strpos($url, "Setting") || strpos($url, "Component") || $_SESSION['Usertype'] == "Admin") {
