...
function Navbar($path, $user){
  ...
  switch($user){
    case "Guest": headtag($path); GuestNavbar(); break;
    case "Company": headtag($path); CompanyNavbar(); break;
    case "Collage": headtag($path); CollageNavbar(); break;
    case "Student": headtag($path); StudentNavbar(); break;
    case "Admin": headtag($path); AdminNavbar(); break;
    default: headtag($path); CommonHeader();
  }
}
...
<div class='app-brand demo'>
                  <a href='#' class='app-brand-link'>
                      ...
                      <span 
                        class='app-brand-text demo menu-text fw-bolder ms-2' href='./index.php'>Placement Plus
                      </span>
                  </a>
